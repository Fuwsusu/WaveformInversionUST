...
enableIllumComp = false;    % true=开启照明补偿；false=关闭（退回标准梯度）
...
enableLFPrior    = false;     % true=开启三阶段LF先验；false=关闭
...
enableTV  = false;     % true=开启各向同性TV；false=关闭
...
enablePolarReg = false;     % true=开启极坐标径向TV；false=关闭
